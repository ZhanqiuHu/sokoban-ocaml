(** Representation of dynamic map state. This module represents the
    state of a map as it is being played, including the player's current
    position, the puzzle pieces that have been correctly placed, and
